...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const inFlight = kits.some((k) => k.status === "pending" || k.status === "generating");
    if (!inFlight) return;
  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <h1 className="font-heading text-2xl font-semibold text-ink">Your kits</h1>
        <Link href="/kits/new">
      ...
      <div className="mt-6">
        ...
        {state === "error" && (
          <div className="rounded-lg border border-coral/40 bg-coral/5 px-4 py-6 text-center">
            <p className="text-sm text-coral">Couldn&apos;t load your kits. Check your connection and try again.</p>
